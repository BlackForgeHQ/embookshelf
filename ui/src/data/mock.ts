// Mock dataset lifted from the Claude Design prototype (embookshelf.html).
// Types are declared once here so every ported component can import them
// without chasing `any`. Content will be replaced by JSON API calls once
// the Go backend exposes /api/v1/*.
...
export type BookFormat = 'EPUB' | 'PDF' | 'CBZ' | 'M4B';
...
export const MAGIC_SHELVES: MagicShelf[] = [
...
export const READER_CONTENT = {
  ...
  paragraphs: [
    ...
    '"Ingrid Vaal. I have your grandfather\'s last notebook. He told me you\'d come for it in your own time, and I have learned not to argue with him, even now."',
  ],
};

export const BOOKDROP_FILES: BookDropFile[] = [
...
export const ACTIVITY: number[] = [
  23,0,41,55,22,0,12, 34,27,0,0,48,51,15, 0,22,34,28,0,0,41,
  18,30,42,0,22,36,44, 28,38,0,55,41,29,0, 33,22,0,31,49,38,20,
  44,30,52,0,27,41,33, 0,38,45,22,18,0,36, 41,33,28,55,42,0,38,
  22,48,31,0,26,44,35, 38,55,29,42,33,0,47, 51,28,36,44,52,0,38,
];
