...
function renderPath(name: IconName) {
  switch (name) {
    case "book":
      return (
        <path d="M4 4h11a3 3 0 013 3v13H7a3 3 0 01-3-3V4zm0 13h14M4 4a1 1 0 00-1 1v12a3 3 0 003 3" />
      )
    case "book-open":
      return (
        <>
    ...
    case "home":
      return (
        <path d="M3 10l9-7 9 7v10a1 1 0 01-1 1h-5v-7h-6v7H4a1 1 0 01-1-1V10z" />
      )
    case "search":
      return (
        <>
    ...
    case "star":
      return (
        <path d="M12 3l2.6 5.9 6.4.6-4.8 4.4 1.4 6.3L12 17l-5.6 3.2 1.4-6.3L3 9.5l6.4-.6L12 3z" />
      )
    case "star-half":
      return (
        <>
          <path
            d="M12 3v14l-5.6 3.2 1.4-6.3L3 9.5l6.4-.6L12 3z"
            fill="currentColor"
            stroke="none"
          />
    ...
    case "star-filled":
      return (
        <path
          d="M12 3l2.6 5.9 6.4.6-4.8 4.4 1.4 6.3L12 17l-5.6 3.2 1.4-6.3L3 9.5l6.4-.6L12 3z"
          fill="currentColor"
        />
      )
    case "circle":
    ...
    case "bell":
      return (
        <path d="M6 9a6 6 0 1112 0c0 5 2 7 2 7H4s2-2 2-7zM10 20a2 2 0 004 0" />
      )
    case "menu":
      return <path d="M3 6h18M3 12h18M3 18h18" />
    case "more":
