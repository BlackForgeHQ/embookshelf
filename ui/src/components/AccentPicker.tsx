        ...
        return (
          <button
            ...
            className={cn(
              ...
              "focus-visible:ring-2 focus-visible:ring-(--color-ink-3) focus-visible:ring-offset-2 focus-visible:ring-offset-(--color-paper-0) focus-visible:outline-none",
              selected
                ? "scale-110 ring-2 ring-(--color-ink-1) ring-offset-2 ring-offset-(--color-paper-0)"
                : "hover:scale-110"
            )}
