...
import type { SettingsLibrary } from "@/api/settings"
import {
...
export const MODIFIER_REFERENCE: ReadonlyArray<{
  token: string
  desc: string
}> = [
...
export const BASIC_EXAMPLES: ReadonlyArray<ExampleBlock> = [
  {
    ...
    rows: [
      { caption: "", output: "Patrick Rothfuss - The Name of the Wind.epub" },
    ],
  },
  {
    ...
    rows: [
      {
        caption: "",
        output:
          "Patrick Rothfuss/The Kingkiller Chronicle/01 - The Name of the Wind.epub",
      },
    ],
  },
  {
    ...
    rows: [
      { caption: "", output: "The Name of the Wind Special Edition.epub" },
    ],
  },
  {
    label: "Absolute path",
  ...
  },
  {
    ...
    pattern: "{title}/",
    rows: [
      { caption: "", output: "The Name of the Wind/the_name_of_the_wind.epub" },
    ],
  },
  {
    label: "Year prefix",
    ...
    rows: [
      {
        ...
        output: "The Name of the Wind Special Edition.epub",
      },
      { caption: "Without", output: "Project Hail Mary.epub" },
    ],
  },
...
export const MODIFIER_EXAMPLES: ReadonlyArray<ExampleBlock> = [
  {
    ...
    rows: [
      { caption: "", output: "Rothfuss, Patrick/The Name of the Wind.epub" },
    ],
  },
  {
  ...
  },
  {
    ...
    rows: [
      { caption: "", output: "T/Patrick Rothfuss/The Name of the Wind.epub" },
    ],
  },
  {
  ...
  return (
    <>
      ...
      <p className="t-small" style={{ marginBottom: 24, fontStyle: "italic" }}>
        ...
        they fall back to the default below. An empty default means &ldquo;keep
        the original filename&rdquo;.
      </p>

      <h3 className="t-h3" style={{ marginTop: 0, marginBottom: 8 }}>
        Default pattern
      </h3>
      <Card>
        <PatternEditor
      ...
      <p className="t-small" style={{ marginBottom: 16, fontStyle: "italic" }}>
        ...
        make them conditional. If any placeholder in the block has no value, the
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
      ...
      {debounced !== "" && (
        ...
        >
          <span className="t-micro" style={{ marginRight: 8 }}>
            Preview
          </span>
